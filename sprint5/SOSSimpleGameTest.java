...
public class SOSSimpleGameTest {
    ...
    @Test
        public void testBlueWin() {
            game.makeMove(0, 0, 'S');
            game.makeMove(0, 1, 'O');
            assertTrue(game.makeMove(0, 2, 'S')); // This should form an SOS and end the game
            assertTrue(game.getSOSFormed());
            assertEquals('B',game.getWinner()); // The game should be ending after the SOS is formed
        }
        ...
        public void testRedWin() {
            ...
            assertTrue(game.makeMove(0, 2, 'S')); // This should form an SOS and end the game
            assertTrue(game.getSOSFormed());
            assertEquals('R',game.getWinner()); // The game should be ending after the SOS is formed
        }
